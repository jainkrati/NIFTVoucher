...
contract NIFTVoucher is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("NIFTVoucher", "NIFTV") {
    }
    ...
    function mint(string memory description, uint256 amount ,address payable receiverAddress) public payable {
        ...
        Voucher memory voucher = Voucher(
            string(abi.encodePacked("NIFTVoucher", uint256(supply + 1).toString())),
            description,
            amount,
            receiverAddress,
            false
